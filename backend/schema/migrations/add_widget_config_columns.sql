-- ============================================================================
-- 🆕 MIGRATION: Add Missing Widget Configuration Columns
-- ============================================================================
-- Run this ONLY if you're getting "column not found" errors
-- This adds all missing columns to the existing global_widget_config table
-- ============================================================================
...
ADD COLUMN IF NOT EXISTS offline_message TEXT DEFAULT 'We''re currently offline. Leave a message and we''ll get back to you!',
...
ADD COLUMN IF NOT EXISTS queue_message TEXT DEFAULT 'All agents are busy. You are in the queue.',
...
ADD COLUMN IF NOT EXISTS predefined_tags TEXT[] DEFAULT ARRAY['urgent', 'feedback', 'support', 'sales'],
ADD COLUMN IF NOT EXISTS webhook_url TEXT,
ADD COLUMN IF NOT EXISTS webhook_events TEXT[] DEFAULT ARRAY['message', 'session_start', 'session_end'],
...
-- Now try saving your widget configuration again!
-- ============================================================================
